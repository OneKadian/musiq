...
export function TopSongsOverview({ className }: PropsType) {
  ...
  { "Song Name": "Anti-Hero - Taylor Swift", Streams: 4823123 },
  {  "Song Name": "Lose Yourself - Eminem", Streams: 5344444 },
  {  "Song Name": "Die For You - The Weeknd", Streams: 5362345 },
  { "Song Name": "God's Plan - Drake", Streams: 1244444 },
  {  "Song Name": "Not Like Us - Kendrick Lamar", Streams: 4878787 }
  ...
  // Sort by streams in descending order and take top 5
  const data = allData
